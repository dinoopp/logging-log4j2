...
public interface CompressActionFactory {
     ...
     * <p>
     *     The value must be an {@code int} between -1 (default) and 9.
     * </p>
     */
     ...
     */
    Action createCompressAction(Path source, Path destination, Map<String, ?> options);
     ...
     * @return An action the compresses the source file.
     */
    default Action createCompressAction(String source, String destination, Map<String, ?> options) {
